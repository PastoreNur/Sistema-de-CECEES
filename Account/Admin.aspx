<%@ Page Title="" Language="C#" MasterPageFile="~/Account/PanelAdmin.master" AutoEventWireup="true" CodeFile="Admin.aspx.cs" Inherits="Account_Admin" %>
    ...
    <div class="row">
            ...
            <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <asp:Button ID="BtnAdministrarALumnos" runat="server" Text="Administrar" class="btn btn-block btn-primary" OnClick="BtnAdministrarALumnos_Click"/>
                    </div>
                </div>
               </div>
         ...
         <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <asp:Button ID="BtnAdministrarPersonal" runat="server" Text="Administrar" class="btn btn-block btn-primary" OnClick="BtnAdministrarPersonal_Click"/>
                    </div>
                </div>
         </div>
    </div>
    ...
    <div class ="row">
        <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                          <asp:Button ID="BtnAdministrarNotas" runat="server" Text="Administrar" class="btn btn-block btn-primary" OnClick="BtnAdministrarNotas_Click"/>
                    </div>
                </div>
               </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                         <asp:Button ID="BtnAdminsitarHorarios" runat="server" Text="Administrar" class="btn btn-block btn-primary" OnClick="BtnAdminsitarHorarios_Click"/>
                    </div>
                </div>
            </div>
         ...
         <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <asp:Button ID="BtnAdministrarPagos" runat="server" Text="Administrar" class="btn btn-block btn-primary" OnClick="BtnAdministrarPagos_Click"/>
                    </div>
                </div>
         </div>
